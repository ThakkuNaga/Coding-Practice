...
class MinProductSubset {
    /*
     * 
     * A simple solution is to generate all subsets, find the product of every
     * subset and return the minimum product.
     * A better solution is to use the below facts.
     * 
     * 1. If there are even number of negative numbers and no zeros, the result is
     * the
     * product of all except the largest valued negative number.
     * 
     * 2. If there are an odd number of negative numbers and no zeros, the result is
     * simply the product of all.
     * 
     * 3. If there are zeros and positive, no negative, the result is 0. The
     * exceptional case is when there is no negative number and all other elements
